...
const Header = () => {
    ...
    return (
        <div id="start" className="fixed top-0 border-b-1 border-gray-900 w-full bg-gradient-to-b from-black to-transparent">
            <div onClick={open ? (() => setOpen(!open)): (() => setOpen(!open))} className=" grid lg:grid-cols-3 md:grid-cols-3 grid-cols-2">
